...
use App\Http\Resources\NewsCollections;
use App\Models\News;
...
class NewsController extends Controller
{
    ...
    {
        $news = new NewsCollections(News::OrderByDesc('id')->paginate(8));
        return Inertia::render('Homepage', [
            'title' => "LaravelNews Home",
            'description' => "Selamat datang di LaravelNews Portal",
            'news' => $news
        ]);
    }
